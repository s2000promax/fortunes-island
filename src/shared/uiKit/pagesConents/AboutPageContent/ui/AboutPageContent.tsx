    ...
    <div className={classNames(cls.aboutPageContent, {}, [className])}>
      ...
      <main>
        <section className={classNames(cls.text)}>
          ...
          <h2>{t('Overview: ')}</h2>
          <p>
            {t(`Fortune's Island is an online multiplayer gambling game set on a mysterious tropical 
        ...
        <section className={classNames(cls.text)}>
          ...
          <ol>
            <li>
              {t(`Character Creation: Players create a customizable avatar to represent themselves in the game. 
              They can personalize their character's appearance, clothing, and accessories to stand out among 
              other players.`)}
            </li>
            <li>
              {t(`The Island: The island is divided into several regions, each with its own theme and gambling games. 
            ...
            <ul>
              <li>
                {t(`Pirate's Cove: Features classic card games like Poker, Blackjack, and Baccarat.`)}
              </li>
              <li>
                {t(`Ancient Temple: Offers various slot machines and themed minigames based on ancient civilizations.`)}
              </li>
              <li>
                {t(`Royal Casino: Includes high-stakes games such as RouletteBody, Craps, and exclusive VIP rooms.`)}
              </li>
              <li>
                {t(`Treasure Hunts: Players can participate in treasure hunts to discover hidden loot, 
            ...
            <li>
              {t(`Daily Challenges and Events: Players can participate in daily challenges and special events that 
            ...
            <li>
              {t(`In-Game Economy: Players can earn in-game currency by winning gambling games or participating 
            ...
            <li>
              {t(`Social Features: Fortune's Island is a social experience, allowing players to interact with others 
        ...
        <section className={classNames(cls.text)}>
          ...
          <p>
            {t(`Fortune's Island can be monetized through in-game purchases, such as buying 
