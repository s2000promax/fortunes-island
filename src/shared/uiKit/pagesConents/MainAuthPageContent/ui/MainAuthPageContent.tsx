    ...
    <div className={classNames(cls.mainAuthPage, {}, [className])}>
      {
        userBalance > 0 ? (
          <>
            <div>
              <p>{t(`Step right up and immerse yourself in the world of American Roulette at Fortune Island Casino, 
      ...
      Will the ball land on your lucky number, or will it be the color you've been dreaming of?`)}
              ...
              <p>{t(`Fortune favors the bold, and with a balance of $${userBalance}, 
      you're well on your way to discovering your destiny at the American Roulette table. `)}
              </p>
              <p>{t(`Place your bets and watch as the wheel unveils the secrets of your fortune. 
      It's time to spin, win, and revel in the exhilarating American Roulette experience that awaits!`)}
          ...
          <>
            <div>
              <p>
                {t(`So you find yourself at the Roulette table with empty pockets, 
              ...
              <p>
                {t(`Soon, your fortune will change, and the Roulette table will be waiting 
